...
class ContentQuestionnaireTwoAdmin extends StatelessWidget {
  const ContentQuestionnaireTwoAdmin({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<QuetionnairCubitAdmin, QuetionnairAdminState>(

      listener: (context, state) {
        // TODO: implement listener
      },
      builder: (context, state) {
        var cubuit=QuetionnairCubitAdmin.get(context);
        return SafeArea(
          child: Column(
            children: [
              SizedBox(
