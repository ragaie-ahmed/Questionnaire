...
import 'package:doctor/Features/Presentation/View/HomeScreen/QualityStandardPage/Screens/QualityStandardPageSix.dart';
...
class QualityStandardPageFive extends StatelessWidget {
  const QualityStandardPageFive({super.key});
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return const QualityStandardPageSix();
                      },
                    ));
                  },
                  child: Image.asset(
