...
import 'package:doctor/Features/Presentation/View/HomeScreen/QualityStandardPage/Screens/QualityStandardPageThree.dart';
...
class QualityStandardPageTwo extends StatelessWidget {
  const QualityStandardPageTwo({super.key});
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return const QualityStandardPageThree();
                      },
                    ));
                  },
                  child: Image.asset(
