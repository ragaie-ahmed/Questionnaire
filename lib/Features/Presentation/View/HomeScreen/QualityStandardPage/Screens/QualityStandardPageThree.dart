...
import 'package:doctor/Features/Presentation/View/HomeScreen/QualityStandardPage/Screens/QualityStandardPageFour.dart';
...
class QualityStandardPageThree extends StatelessWidget {
  const QualityStandardPageThree({super.key});
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return const QualityStandardPageFour();
                      },
                    ));
                  },
                  child: Image.asset(
